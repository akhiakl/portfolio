        ...
        roles: [
            {
                ...
                description: [
                    "Led frontend delivery across multiple high-traffic storefronts, coordinating engineering, design and backend stakeholders.",
                    "Established component scaffolding, CI workflows and coding standards that improved release reliability and engineering velocity.",
                    "Shipped core platform features with a focus on accessibility, performance and scalable architecture."
                ],
            },
            {
